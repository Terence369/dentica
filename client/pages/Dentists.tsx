    ...
    <div>
      <section className="border-b bg-gradient-to-b from-sky-50 to-white">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://cdn.builder.io/api/v1/image/assets%2F2bdfb75c4a42464ea64f680845f3e793%2F3d7be5d58c814a05a5ecf6be25fba197)",
        ...
        >
          ...
          <p className="mt-2 text-muted-foreground">
            <span style={{ color: "rgb(0,0,0)" }}>Our Expert Team</span>
          </p>
        </div>
      </section>
      ...
      <section
        style={{ backgroundColor: "rgba(224, 242, 254, 1)" }}
        className="py-8"
      >
