  ...
  return (
    <div>
      ...
      <section className="container mx-auto grid gap-10 py-12 md:grid-cols-2">
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-black/5">
            <div>
            ...
            <Button disabled={isSubmitting} className="rounded-full bg-teal-500 hover:bg-teal-600">{isSubmitting ? 'Sending...' : 'Send message'}</Button>
            {isSubmitSuccessful && <p className="text-sm text-green-600">Message sent! We will get back to you shortly.</p>}
          </form>
        </div>
